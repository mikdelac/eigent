...
export default function MCPDeleteDialog({
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-dialog-overlay-scrim">
      <div className="min-w-[320px] max-w-[90vw] rounded-lg bg-ds-bg-neutral-inverse-default p-6 shadow-lg">
