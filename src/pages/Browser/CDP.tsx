    ...
    <div className="m-auto flex h-full w-full flex-1 flex-col">
      ...
      <div className="mb-8 flex flex-col gap-6">
        <div className="flex w-full flex-col items-end justify-between gap-4 rounded-2xl bg-ds-bg-neutral-default-default px-6 py-4">
          ...
          {/* Content Section */}
          <div className="mt-4 flex min-h-[200px] w-full flex-col gap-2">
      ...
      {showConnectDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-dialog-overlay-scrim">
          <div className="w-full max-w-md rounded-xl bg-ds-bg-neutral-subtle-default p-6 shadow-lg">
