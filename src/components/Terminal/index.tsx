...
export default function TerminalComponent({
  ...
  const promptText = 'steamOvap:~$ '; // prompt text
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (showWelcome) {
        terminal.writeln('\x1b[32m=== steamOvap Terminal ===\x1b[0m');
      ...
      newData.forEach((item) => {
        ...
        if (formattedOutput.trim()) {
          xtermRef.current.writeln(
            `\x1b[36m[steamOvap]\x1b[0m ${formattedOutput}`
          );
        } else {
          xtermRef.current.writeln('');
        }
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (showWelcome) {
        xtermRef.current.writeln('\x1b[32m=== steamOvap Terminal ===\x1b[0m');
