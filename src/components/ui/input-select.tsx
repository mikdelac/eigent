    ...
    return (
      ...
      >
        ...
        <div
          ...
          className={cn(
            'relative flex w-full cursor-text items-center gap-2 rounded-lg border border-solid px-3 text-ds-text-neutral-default-default shadow-sm outline-none transition-all',
