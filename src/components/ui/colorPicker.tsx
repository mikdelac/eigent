  ...
  return (
    <div className="flex select-none flex-col gap-3">
      ...
      >
        ...
        />
        <div
          className="bg-white pointer-events-none absolute h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-ds-border-neutral-default-default shadow-lg"
          style={{
            left: `${sat * 100}%`,
            top: `${(1 - val) * 100}%`,
          }}
      ...
      >
        <div
          className="bg-white pointer-events-none absolute top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-ds-border-neutral-default-default shadow-lg"
          style={{
            left: `${(hue / 360) * 100}%`,
          }}
        />
      ...
      <div className="flex items-center gap-2">
        <div
          className="h-8 w-8 flex-shrink-0 rounded-md border border-solid border-ds-border-neutral-default-default"
