...
export function QueuedBox({
  ...
  return (
    <div
      className={cn(
        'border-solid-80 flex w-full flex-col items-start justify-center gap-1 rounded-t-2xl border border-b-0 border-ds-border-neutral-default-default bg-ds-bg-neutral-default-default py-1',
        className
      )}
    >
      {/* Queuing Header Top */}
