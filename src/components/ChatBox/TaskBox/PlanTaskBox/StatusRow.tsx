...
export function StatusRow({ chatStore, taskId, className }: StatusRowProps) {
  ...
  return (
    ...
    >
      ...
      <span className="shrink-0 text-body-sm font-bold text-ds-text-information-default-default">
        {t('chat.splitting-tasks')}
      </span>
      <span className="shrink-0 text-body-sm font-normal tabular-nums text-ds-text-neutral-subtle-default">
        {formatSplittingElapsed(elapsedMs)}
      </span>
      <span className="shrink-0 text-body-sm font-normal text-ds-text-neutral-subtle-default">
        •
      </span>
      <span className="flex shrink-0 items-center gap-1 text-body-sm font-normal text-ds-text-neutral-subtle-default">
