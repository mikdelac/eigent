      ...
      {taskInfo.map((task, index) => (
        ...
        >
          ...
          <textarea
            ...
            rows={1}
            className="min-w-0 flex-1 resize-none border-none bg-transparent text-body-sm font-normal leading-10 text-ds-text-neutral-default-default placeholder:text-ds-text-neutral-subtle-disabled focus:outline-none"
          />
        </div>
      ))}
    </div>
