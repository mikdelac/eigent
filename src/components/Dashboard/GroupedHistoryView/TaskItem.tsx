...
export default function TaskItem({
  ...
  return (
    <div
      onClick={onSelect}
      className={` ${isActive ? '!bg-ds-bg-neutral-inverse-default' : ''} bg-ds-bg-neutral-inverse-default/30 relative flex h-14 w-full cursor-pointer items-center justify-between gap-md rounded-xl border border-solid border-ds-border-neutral-muted-disabled p-3 shadow-history-item transition-all duration-300 hover:bg-ds-bg-neutral-inverse-default ${!isLast ? 'mb-2' : ''} `}
    >
